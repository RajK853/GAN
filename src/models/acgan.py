...
class ACGAN(BaseGAN):
    ...
    def load_generator(self, latent_in, label_in):
        ...
        x = layers.Dense(7*7*64, activation="relu", kernel_regularizer="l2")(x)
    ...
    def generate_feed_dict(self, batch_size):
        ...
        self._batch_feed_dict["gen_inputs"] = [latent_vectors, fake_class_labels]
        self._batch_feed_dict["gen_outputs"] = [ones_labels, fake_class_labels]
